...
udpSvrSck = net.createUDPSocket()
udpSvrSck:listen(53)  -- DNS
udpSvrSck:on("receive", function(udpSvrSck, data, port, ip)
  print(string.format("received '%s' from %s:%d", data, ip, port))
  decodedns(data)
  udpSvrSck:send(port, ip, dns_tr..dns_str1..dns_q..dns_str2..dns_strIP)
  collectgarbage()
end)
port, ip = udpSvrSck:getaddr()
